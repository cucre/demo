        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-content">
                <div class="brand" style="text-align: center;">
                    <h3>Recurso no disponible (301).</h3>
                </div>
                <div class="row">
                    <div class="center">
                        <p>No encontramos la página que estás buscando. Puedes <a href="{{ route('home') }}"><mark>ir al inicio</mark></a> o ponerte en contacto con nosotros.</p>
                    </div>
                </div>
