        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-content">
                <div class="brand" style="text-align: center;">
                    <h3>Método no permitido (405).</h3>
                </div>
                <div class="row">
                    <div class="center">
                        No encontramos el método que estás buscando. Puedes <a href="{{ route('home') }}"><mark>ir al inicio</mark></a> o ponerte en contacto con nosotros.
                    </div>
                </div>
