        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-content">
                <div class="brand" style="text-align: center;">
                    <h3>Sesión expirada (419).</h3>
                </div>
                <div class="row">
                    <div class="center">
                        Disculpe las molestias pero su sesión ha expirado. Puedes <a href="{{ route('login') }}"><mark>iniciar sesión</mark></a> o ponerte en contacto con nosotros.
                    </div>
                </div>
