...
@section('content')
        ...
        <form id="modal-form" method="post">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <h5 class="modal-title" id="delModalLabel">¿Eliminar materia?</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-lg-12 text-center">
                            ¿Estás seguro que quieres eliminar la materia <strong id="subject_name"></strong>?
                        </div>
                    </div>
    ...
    <div class="modal fade" id="resModal" tabindex="-1" role="dialog" aria-labelledby="resModal" aria-hidden="true">
        <form id="modal-form-res" method="post">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    <h5 class="modal-title" id="delModalLabel">¿Restaurar materia?</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="col-lg-12 text-center">
                            ¿Estás seguro que quieres restaurar la materia <strong id="subject_name_res"></strong>?
                        </div>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title">Materias del sistema</h4>
            <div class="panel-heading-btn">
                @can('materias.create')<a href="{{ route('materias.create') }}" class="btn btn-indigo btn-sm"><i class="fas fa-user-plus"></i>&nbsp; Agregar materia</a>&nbsp;&nbsp;&nbsp;&nbsp;@endcan
